...
public class RightArrowController : MonoBehaviour
{
    ...
    public void Start(){
        ...
        Debug.Log("In Start of Right Arrow controller");
    }
    public void OnPointerEnter()
    {
        Debug.Log("In OnPointer Enter in Right Arrow controller");
    ...
    public void OnPointerExit()
    {
        ...
        Debug.Log("In OnExit in Right Arrow controller");
        currentMaterial.material = defaultMaterial;
    ...
    {
        Debug.Log("In OnPointer Click in Right Arrow controller");
